    ...
    <body>
        ...
        <div class="x-body">
            ...
            <xblock><!--<button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button>-->
            	<button class="layui-btn" onclick="role_add('添加人员角色','./userRoleAddPage','900','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有角色：${fn:length(userRoles)}条</span></xblock>
            <table class="layui-table">
                ...
                <c:if test="${userRoles==null || fn:length(userRoles) == 0}">  
					<tr>  
					  <td colspan="4">人员角色为空</td>
					</tr>   
				</c:if>  
					  ...
					  <tr >  
					    ...
					    <c:choose>
							<c:when test="${item.delete==0}">
								<td class="td-manage">
	                            <a title="编辑" href="javascript:;" onclick="role_edit('编辑','./userRoleEditPage?id=${item.id}','4','','510')"
