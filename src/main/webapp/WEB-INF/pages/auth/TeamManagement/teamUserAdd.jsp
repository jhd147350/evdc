    ...
    <body>
        <div class="x-body">
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="button" name="add" id="addTeamUser" value="增加" class="layui-btn"/>
                </div>
            </form>
        </div>
        ...
        <script>
            layui.use(['form','layer'], function(){
              ...
              //监听提交
              var but = document.getElementById("addTeamUser");
    			but.addEventListener("click", function(){
                	...
                	$.ajax({  
                        ...
                        dataType: 'json',
                        data: {
                        	"name": teamUserName.value, "role": userRole, "phone": phone.value, "email": userEmail.value, "password": userPassword.value, "loginId": loginId.value
                        },
                        timeout: 1000,  
                        cache: false,     
                 	}).done(function(data) { 
                 		if(data.status==1){
							...
							layer.alert("登录名已被使用", {icon: 5},function () {
